from keras.layers import Input, Conv2D, MaxPooling2D, Dropout, Conv2DTranspose, Activation, Add, Cropping2D
...
def fcn8():
  ...
  o = x
  o = Conv2D(4096, (7,7), activation='relu', padding='same', name='fcn_conv1')(o)
  o = Dropout(0.5)(o)
  o = Conv2D(4096, (1,1), activation='relu', padding='same', name='fcn_conv2')(o)
  o = Dropout(0.5)(o)
